...
namespace Nefarius.Drivers.Identinator.Util;
...
internal static class RegistryExtensions
{
    ...
    public static IEnumerable<string>? GetStringArray(this RegistryKey key, string valueName,
        IEnumerable<string>? defaultValue = default)
    {
